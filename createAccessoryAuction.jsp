...
try {
	...
	|| !StringUtils.isNumeric(request.getParameter("startPriceCent"))){
		response.sendRedirect("createAccessoryAuction1.jsp");
		return;
	}
	...
	String insert = "INSERT INTO newAuction(title, `desc`, cat, type, color, brand, `condition`, material, startPrice, minIncr, minSalePrice, endDateTime, auc_user) "
			+ "VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	PreparedStatement ps = con.prepareStatement(insert);
		...
		ps.setFloat(9, startPrice2);
		ps.setFloat(10, minIncrement);
		ps.setFloat(11, minSalePrice2);
