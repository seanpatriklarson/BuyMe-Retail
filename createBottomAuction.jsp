...
try {
	...
	String lengthsize = request.getParameter("lengthSize");
	String brand = request.getParameter("brand");
	String condition = request.getParameter("condition");
	String material = request.getParameter("material");
	String minBidIncr = request.getParameter("minBid");
	
	String size = waistsize +"x" + lengthsize;
	...
	|| !StringUtils.isNumeric(request.getParameter("startPriceCent"))){
		response.sendRedirect("createBottomAuction1.jsp");
		return;
	}
	...
	String insert = "INSERT INTO newAuction(title, `desc`, cat, type, size, color, brand, `condition`, material, startPrice, minIncr, minSalePrice, endDateTime, auc_user) "
			+ "VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	PreparedStatement ps = con.prepareStatement(insert);
	ps.setString(1, title);
	ps.setString(2, description);
	ps.setString(3, "bottoms");
	ps.setString(4, type);
	ps.setString(5, size);
