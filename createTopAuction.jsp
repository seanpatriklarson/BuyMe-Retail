...
try {
	...
	|| !StringUtils.isNumeric(request.getParameter("startPriceCent"))){
		response.sendRedirect("createTopAuction1.jsp");
		return;
	}
	...
	String insert = "INSERT INTO newAuction(title, `desc`, cat, type, size, color, brand, `condition`, material, startPrice, minIncr, minSalePrice, endDateTime, auc_user, timeDuration) "
			+ "VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
